...
import { Blocks, Settings, CalendarSync, LayoutDashboard, Plus, Users, DollarSign, Brain, Puzzle, Hash, type LucideIcon } from 'lucide-react'
...
const TOP_NAV: NavItem[] = [
  ...
  { Icon: Puzzle, label: 'Plugins', route: '/plugins' },
