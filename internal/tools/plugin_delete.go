...
func (t *SkillDeleteTool) Name() string { return "plugin_delete" }
func (t *SkillDeleteTool) Description() string {
	return "Delete an installed plugin or skill by name. Only items in the managed skills directory can be removed."
}
